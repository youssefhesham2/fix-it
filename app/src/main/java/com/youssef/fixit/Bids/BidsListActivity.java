...
public class BidsListActivity extends AppCompatActivity {
    ...
    public class BidsAdapter extends RecyclerView.Adapter<BidsListActivity.BidsAdapter.viewholder> {
        ...
        @NonNull
        @Override
        public com.youssef.fixit.Bids.BidsListActivity.BidsAdapter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bids_item, parent, false);
            return new com.youssef.fixit.Bids.BidsListActivity.BidsAdapter.viewholder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull com.youssef.fixit.Bids.BidsListActivity.BidsAdapter.viewholder holder, int position) {
